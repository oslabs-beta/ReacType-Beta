...
/**
 * `AddModule` is a React component that facilitates the creation and management of component entities
 ...
 */
const AddModule = ({ setIsCreatingModule, isThemeLight }): JSX.Element => {
